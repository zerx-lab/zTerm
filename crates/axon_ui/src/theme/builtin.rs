    ...
    let colors = ThemeColors {
        ...
        terminal: TerminalColors {
            ...
            ansi: TerminalAnsiColors {
                ...
                blue: hsla(221.0 / 360.0, 0.54, 0.32, 1.0), // #34548a - 降低亮度：0.37 -> 0.32
                magenta: hsla(256.0 / 360.0, 0.23, 0.37, 1.0), // #5a4a78
                cyan: hsla(203.0 / 360.0, 0.75, 0.24, 1.0), // #0f4b6e
                white: hsla(228.0 / 360.0, 0.11, 0.60, 1.0), // #9699a3
                ...
                bright_blue: hsla(221.0 / 360.0, 0.64, 0.40, 1.0), // #3d5fa8 - 降低亮度：0.47 -> 0.40
                bright_magenta: hsla(256.0 / 360.0, 0.33, 0.47, 1.0), // #6f5c94
                bright_cyan: hsla(203.0 / 360.0, 0.85, 0.34, 1.0), // #166585
                bright_white: hsla(228.0 / 360.0, 0.14, 0.30, 1.0), // #434758
            },
        },
    };
